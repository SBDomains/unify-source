    ...
    nTotalWeight(0)
{
    ...
    setWindowTitle(tr("Unify") + " - " + tr("Wallet"));
...
void BitcoinGUI::createActions()
{
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Unify"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Unify addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Unify addresses"));
...
#ifndef Q_OS_MAC
            QApplication::setWindowIcon(QIcon(":icons/unify_testnet"));
            setWindowIcon(QIcon(":icons/unify_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/unify_testnet"));
#endif
            if(trayIcon)
            {
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Unify client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Unify network", "", count));
}
...
{
    QString strTitle = tr("Unify"); // default title
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Unify address or malformed URI parameters."),
...
void BitcoinGUI::updateStakingIcon()
{
    ...
    if (nLastCoinStakeSearchInterval && nAverageWeight)
    {
        ...
        uint64 nEstimateTime = nTargetSpacing * nNetworkWeight / nTotalWeight;
